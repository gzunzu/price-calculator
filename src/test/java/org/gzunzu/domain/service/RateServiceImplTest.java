...
import org.gzunzu.domain.repositories.RateRepository;
...
class RateServiceImplTest {
    ...
    @InjectMocks
    private RateServiceImpl uat;
    @Mock
    private RateRepository repository;

    @BeforeAll
    static void setUp() {
        autoCloseable = MockitoAnnotations.openMocks(RateServiceImplTest.class);
    }
    ...
    static void tearDown() {
        try {
            ...
            log.warn("Error trying to close {} class mocks.", RateServiceImplTest.class, exception);
        }
    }
    ...
    void test_getById_entityFound() {
        ...
        final Rate actual = uat.getById(1L);
    ...
    void test_getAll_entitiesFound() {
        ...
        final List<Rate> actual = uat.getAll();
    ...
    void test_save_notNullEntity() {
        ...
        final Rate actual = uat.save(entity);
    ...
    void test_update_notNullEntity() {
        ...
        final Rate actual = uat.update(1L, entity2);
    ...
    void test_update_nullEntity() {
        ...
        final Rate actual = uat.update(1L, null);
