...
import org.gzunzu.domain.repositories.BrandRepository;
...
class BrandServiceImplTest {
    ...
    @InjectMocks
    private BrandServiceImpl uat;
    @Mock
    private BrandRepository repository;

    @BeforeAll
    static void setUp() {
        autoCloseable = MockitoAnnotations.openMocks(BrandServiceImplTest.class);
    }
    ...
    static void tearDown() {
        try {
            ...
            log.warn("Error trying to close {} class mocks.", BrandServiceImplTest.class, exception);
        }
    }
    ...
    void test_getById_entityFound() {
        ...
        final Brand actual = uat.getById(1);
    ...
    void test_getAll_entitiesFound() {
        ...
        final List<Brand> actual = uat.getAll();
    ...
    void test_save_notNullEntity() {
        ...
        final Brand actual = uat.save(entity);
    ...
    void test_update_notNullEntity() {
        ...
        final Brand actual = uat.update(1, entity2);
    ...
    void test_update_nullEntity() {
        ...
        final Brand actual = uat.update(1, null);
